...
export default async function GlossarioPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      <h1 className="text-4xl font-extrabold text-slate-900 mb-4">Glossário Técnico</h1>
      <p className="text-lg text-slate-600 mb-8">Definições claras e diretas dos principais termos utilizados na gestão moderna e em projetos.</p>
      
      <CategoryFilterBar basePath="/artigos" ativa="glossario" />
